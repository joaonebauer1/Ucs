...
public class Class_LevelMedium extends View implements MediaPlayer.OnCompletionListener {
    ...
    public Class_LevelMedium(Context context) {
        super(context);
    }
    ...
    public Class_LevelMedium(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
