...
public class Class_LevelHard extends View implements MediaPlayer.OnCompletionListener {
    ...
    public Class_LevelHard(Context context) {
        super( context );
    }
    ...
    public Class_LevelHard(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
